...
<form action="<%= request.getContextPath()%>/mesQuestionnaires/creerQuestion.html" method="post">
    <table>
        <tr>
            <td>
    ...
    <input type="hidden" name="idQuestionnaire" value="<%= Integer.parseInt(request.getAttribute("idQuestionnaire").toString()) %>" />
